# About translating Fabric Workbench

> [!NOTE]
> All commands **must** be run in `./freecad/Fabric/resources/translations/` directory.
...
at <https://crowdin.com/project/freecad-addons> webpage and find the **Fabric** project.

## Creating file for missing locale

### Using script

To create a file for a new language with all **Fabric** translatable strings execute
...
Also you can rename new `Fabric.ts` file by appending the locale code,
...
once done, look for the **Fabric** project.
...
Now you can contribute your translated `.ts` file to **Fabric** repository,
