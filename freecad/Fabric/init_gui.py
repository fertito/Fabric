...
class Fabric(Gui.Workbench):
    """
    class which gets initiated at startup of the gui
    """
    MenuText = translate("Workbench", "Fabric")
    ToolTip = translate("Workbench", "a simple Fabric")
    ...
    def Deactivated(self):
        ...
        App.Console.PrintMessage(translate(
            "Log",
            "Workbench Fabric de-activated.") + "\n")


Gui.addWorkbench(Fabric())
